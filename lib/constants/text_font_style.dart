...
class TextFontStyle {
  ...
  TextFontStyle._();
  //my custom font
  static final textStylec18cF5EDD7Helve = TextStyle(
    fontFamily: "Helve",
  ...
  static final textStylec32c3B230EHelveBold = TextStyle(
    fontFamily: "Helve",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
    color: AppColors.c3B230E,
    fontSize: 32.sp,
    fontWeight: FontWeight.bold,
  );
  static final textStylec32c3B230EHelve = TextStyle(
    fontFamily: "Helve",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
    color: AppColors.c3B230E,
    fontSize: 32.sp,
  ...
  static final textStylec16c8C7C68Helve = TextStyle(
    fontFamily: "Helve",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
  ...
  static final textStylec16cFFFFFFHelve = TextStyle(
    fontFamily: "Helve",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
  ...
  static final textStylec14c238D1AHelveBold = TextStyle(
    fontFamily: "Helve",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
  ...
  static final textStylec14c238D1AHelve = TextStyle(
    fontFamily: "Helve",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
    color: AppColors.c238D1A,
    fontSize: 14.sp,
  ...
  static final textStylec11c606060DMSans400 = TextStyle(
    fontFamily: "DMSans",
    fontFamilyFallback: const ['Poppins', 'Inter', 'Roboto', 'Noto Sans'],
  ...
  static final textStyle16cFF3A1222DMSans600 = TextStyle(
    fontFamily: "DMSans",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
  ...
  static final textStyle14c949494DMSans400 = TextStyle(
    fontFamily: "DMSans",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
  ...
  static final textStyle14cFF3A1222DMSans600 = TextStyle(
    fontFamily: "DMSans",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
    color: AppColors.cFF3A1222,
    fontSize: 14.sp,
  ...
  static final textStyle16cFFFFFFDMSans600 = TextStyle(
    fontFamily: "DMSans",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
    color: AppColors.cFFFFFF,
    fontSize: 16.sp,
  ...
  static final textStyle14c606060DMSans400 = TextStyle(
    fontFamily: "DMSans",
    fontFamilyFallback: const ['Open Sans', 'Roboto', 'Noto Sans'],
