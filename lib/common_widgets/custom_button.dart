      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [Color(0xFFbfad93), Color(0xFF704149)],
          ),
          boxShadow: [
            BoxShadow(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            disabledForegroundColor: (foregroundColor ?? AppColors.cFFFFFF)
                .withOpacity(0.5),
            elevation: 0,
            shape: RoundedRectangleBorder(
              borderRadius: borderRadius ?? BorderRadius.circular(60.r),
            ),
          ...
          child: isLoading
              ...
              : Text(
                  title,
                  style: textStyle ?? TextFontStyle.textStylec16cFFFFFFHelve,
